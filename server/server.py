...
def download_task(job_id, url, start_sec, end_sec, resolution, output_path):
    try:
        ...
        # Format selector: best video up to chosen resolution + best audio
        ...
        ydl_opts = {
            ...
            # 'cookiefile': 'cookies.txt',      # Fallback if browser method fails
        ...
        # Keep the partial file for debugging (optional)
